@testset "BasicIndividual" begin 
    ...
    @test DeepCompartmentModels.is_timevariable(individual) == false
    @test DeepCompartmentModels.is_timevariable(individual2) == false
    @test DeepCompartmentModels.is_timevariable(individual3) == true
    
    @test DeepCompartmentModels.is_timevariable(DeepCompartmentModels.make_timevariable(individual)) == true
end
...
@testset "Population" begin 
    ...
    @test DeepCompartmentModels.is_timevariable(population) == false
    ...
    @test DeepCompartmentModels.is_timevariable(population_time_var) == true
